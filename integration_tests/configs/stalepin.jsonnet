...
// Declared here rather than added at runtime: create_node() runs a plain
// `init` and inherits none of this -- notably mempool.max-txs, whose -1
// default makes configureEVMMempool install a NoOpMempool.
