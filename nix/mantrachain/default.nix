...
buildGo123Module' rec {
  ...
  src = fetchFromGitHub {
    owner = "MANTRA-Chain";
    repo = pname;
    rev = "b527a62efbf4c94ab6ac3234064b3bce73aae074";
    hash = "sha256-acLi1o/nMV8MLQlgy/YyNuUZCpb5g05/hlS/FBRYSTM=";
  };
  vendorHash = "sha256-SExfMkrCUd0YlU1By4iwZTJFUI0RyAMgLvsAD+cgch8=";
  proxyVendor = true;
