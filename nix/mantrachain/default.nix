...
buildGo123Module' rec {
  ...
  src = fetchFromGitHub {
    owner = "mmsqe";
    repo = pname;
    rev = "ee4a56cebfdb5d2d2e3c74bab0b6854dbcf1a8e4";
    hash = "sha256-vxgIONzYeDXG9kMgYUrmmlDcxkjn1Oqob66Z+SzvGMM=";
  };
  vendorHash = "sha256-liP+tokdS93Be6krqjjLZhkK12IXrTMK1sW8UwmhQVw=";
  proxyVendor = true;
