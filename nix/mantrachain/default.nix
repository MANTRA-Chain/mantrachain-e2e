...
buildGo123Module' rec {
  ...
  src = fetchFromGitHub {
    owner = "MANTRA-Chain";
    repo = pname;
    rev = "ceb574d142c11fa30cea5813ae7786a5ee24edb3";
    hash = "sha256-440uQe0yKHDoD+MLm/qilo/rkGPCE5IeltOuiWZxPgg=";
  };
  vendorHash = "sha256-G4sa266TEddUd8qlH8OU7X2wV1BuvG6ZZv37e3OcG5k=";
  proxyVendor = true;
