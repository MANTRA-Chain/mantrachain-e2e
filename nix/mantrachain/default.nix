...
buildGo123Module' rec {
  ...
  src = fetchFromGitHub {
    owner = "MANTRA-Chain";
    repo = pname;
    rev = "373b36ed1fdc061ff51e1dde8982c12a8179ee91";
    hash = "sha256-kIbB6NamIOjY1Z3U7RtcJTewj3WNDQRjB5uceijbakM=";
  };
  vendorHash = "sha256-YOuvHkh2HyTqYhNnuU3DYcORhUyQj73KSxxRCbfTppk=";
  proxyVendor = true;
