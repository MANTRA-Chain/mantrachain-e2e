...
buildGo123Module' rec {
  ...
  src = fetchFromGitHub {
    owner = "mmsqe";
    repo = pname;
    rev = "c558ea13f50784dfb40252e3629cc43f95cbab02";
    hash = "sha256-wZSC5TF2lRO2tI5luB6M5HWHITMTuAJvL/bxhy3kgJM=";
  };
  vendorHash = "sha256-kFKSo1D0W41jhZPrnHcRbozTim/UyTPBAixXUmI8x04=";
  proxyVendor = true;
