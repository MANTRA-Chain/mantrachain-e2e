...
buildGo123Module' rec {
  ...
  src = fetchFromGitHub {
    owner = "mmsqe";
    repo = pname;
    rev = "fe828c2d2409536c0036aef9dfe25eb7de81cf23";
    hash = "sha256-FrQ3DNUy+NR3qw1x+q1lsf7IkANmp1RF1i7W/82gFbk=";
  };
  vendorHash = "sha256-nRIHeDhm/Uj/kF9foOrvoFMezhvjgC77zvh3w4mm5ts=";
  proxyVendor = true;
