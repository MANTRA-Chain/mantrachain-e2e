...
buildGo123Module' rec {
  ...
  src = fetchFromGitHub {
    owner = "MANTRA-Chain";
    repo = pname;
    rev = "b8c647d0379f89666da16657e46854ea649f0406";
    hash = "sha256-/haNmVtIaIdbL6PCkeM3WIs4rOXOgKBEnW4QpYaAEUI=";
  };
  vendorHash = "sha256-On2oke90UDOyCNAe1LzfbTCudDQX63GrdxRCtoWsHSI=";
  proxyVendor = true;
