...
buildGo124Module' rec {
  ...
  src = fetchFromGitHub {
    owner = "mmsqe";
    repo = pname;
    rev = "4682577c0bc757b0b420bca6cf6a96ca8835efc8";
    hash = "sha256-cPQLgBTELw9siEI0rCncQ6nDpMtGm1DdsgQZXNjF1us=";
  };
  vendorHash = "sha256-3VTPzykT9I0boUU/6Ot5EKnvyx+5ivpPKyVfa/KtXjU=";
  proxyVendor = true;
