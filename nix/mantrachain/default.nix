...
buildGo123Module' rec {
  ...
  src = fetchFromGitHub {
    owner = "MANTRA-Chain";
    repo = pname;
    rev = "a2fef6d1ce0736944107d63a8c468b4842f61df0";
    hash = "sha256-VTzrOG6WSosPT/xiagV4G6Ch1h0fcxwYEJ3IPa+YvgU=";
  };
  vendorHash = "sha256-vXAPjteLBovKmSBMBZ/BPqxVsIVTDBELvd3Op1IkPUU=";
  proxyVendor = true;
