...
buildGo123Module' rec {
  ...
  src = fetchFromGitHub {
    owner = "MANTRA-Chain";
    repo = pname;
    rev = "26d4d2db47a41031d5df5f958d565c4536eb165d";
    hash = "sha256-zWYSjQa+/stbWY4y3rpRQDrV9YpE5bdWdf+iYAa7UGg=";
  };
  vendorHash = "sha256-xo+aWsOnzMkvkGdNh167KzAb5VYKj5jIpCBixfxBIig=";
  proxyVendor = true;
