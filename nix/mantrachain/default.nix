...
buildGo124Module' rec {
  ...
  src = fetchFromGitHub {
    owner = "mmsqe";
    repo = pname;
    rev = "11fe5a7214bbb754bb75e3a49f1a083c84774c8f";
    hash = "sha256-ya6NgECqEHLt49/RammARB/N7LH6H00hkB17wEHpPdw=";
  };
  vendorHash = "sha256-KuFNeca7x6LJ4stZOhrp+qgeRy4kQunW0VilCiiauz8=";
  proxyVendor = true;
