...
buildGo123Module' rec {
  ...
  src = fetchFromGitHub {
    owner = "MANTRA-Chain";
    repo = pname;
    rev = "40c26bd78317299ecbf08cc1854be87778b14440";
    hash = "sha256-NOTRMxaHUevlgycY1LjhWJkwE8RZKQOpP0o+tBK9vig=";
  };
  vendorHash = "sha256-btBB6TVZuYPQgQFgOvnaQfOBOBG1jfmIsAI2oHz5j+M=";
  proxyVendor = true;
