...
buildGo123Module' rec {
  ...
  src = fetchFromGitHub {
    owner = "MANTRA-Chain";
    repo = pname;
    rev = "898685028253a6f5bf12fd362f102bf20886e6b9";
    hash = "sha256-kI+LwO0+D7EbO/+nFXmRwnMl70t+tVK/nKEGHIxu5nk=";
  };
  vendorHash = "sha256-wGXhlDJ71gk1d46pXP6vAN4+b7IvjiH3RGplP6cBJS0=";
  proxyVendor = true;
