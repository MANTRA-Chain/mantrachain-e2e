...
buildGo123Module' rec {
  ...
  src = fetchFromGitHub {
    owner = "MANTRA-Chain";
    repo = pname;
    rev = "c975c75330e30db5332de8a1b13209b42cf00569";
    hash = "sha256-EmYDZ1q5zGxXv4LZAudeRrW7c8wCRQpSIST6/vFSeJI=";
  };
  vendorHash = "sha256-EklmTpchg+SuEzB2YZV853PEU5z7gfsSCiIdoBdef/k=";
  proxyVendor = true;
