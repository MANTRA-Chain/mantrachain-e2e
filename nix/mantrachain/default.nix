...
buildGo123Module' rec {
  ...
  src = fetchFromGitHub {
    owner = "MANTRA-Chain";
    repo = pname;
    rev = "40ba04664d736904dcff3041eabd954450e6b50e";
    hash = "sha256-nE9uKNEtJKdDnv5dtcJGegtdTYScRPQM1SM+VvN9NbE=";
  };
  vendorHash = "sha256-+HYNtNUZhN1Fyy4GKArlhTuS/+6GwmHaGtGYtqMQDxQ=";
  proxyVendor = true;
