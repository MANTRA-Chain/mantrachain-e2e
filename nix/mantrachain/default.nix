...
buildGo123Module' rec {
  ...
  src = fetchFromGitHub {
    owner = "MANTRA-Chain";
    repo = pname;
    rev = "52fe1043e96750bf7b9139fdfb5291182cad7c5a";
    hash = "sha256-WYFiO0jytIFlUs2pGXXdds+2AU7NxjvoB5WN+lI07/c=";
  };
  vendorHash = "sha256-pc0Lq8SGt80IET4PixgLWC4cXX0s3Pmb4D6cXKbiPUU=";
  proxyVendor = true;
