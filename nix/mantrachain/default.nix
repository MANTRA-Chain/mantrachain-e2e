...
buildGo123Module' rec {
  ...
  src = fetchFromGitHub {
    owner = "MANTRA-Chain";
    repo = pname;
    rev = "286d53e9297a47f30cb1ebc111458667107dd6c5";
    hash = "sha256-yvkZoCGOa/K+xTzBWK+JsZS6+xBGajD7dnpZURBlQkA=";
  };
  vendorHash = "sha256-63QiIIL/qLSxvnrIFH7JgnIvENwL3V2MHVv/dMh6zao=";
  proxyVendor = true;
