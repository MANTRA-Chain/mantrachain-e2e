...
buildGo123Module' rec {
  ...
  src = fetchFromGitHub {
    owner = "MANTRA-Chain";
    repo = pname;
    rev = "a242c0504150bfe5ab9fa36d756d12fa019952fa";
    hash = "sha256-sWoTzk6PYi1fWxAwCLhtDsw5PylYZT8vozyG4mCY6Y0=";
  };
  vendorHash = "sha256-P5HoW0FF6oSb3Cf7FIdmoUXJ/DJwbnm9pglA388UrJY=";
  proxyVendor = true;
