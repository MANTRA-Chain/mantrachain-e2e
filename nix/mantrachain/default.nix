...
buildGo123Module' rec {
  ...
  src = fetchFromGitHub {
    owner = "MANTRA-Chain";
    repo = pname;
    rev = "c13db4049fb6a003332ab15c175382b5ce9d8812";
    hash = "sha256-2qc77BF+5ZtnmVFcrGII+1galvZj+u/pZjFACJYW0ZI=";
  };
  vendorHash = "sha256-Wx+XfMptWxqPYDnKWPHpUmw8DcJoAIrKlvwbLq+QZk8=";
  proxyVendor = true;
