...
buildGo123Module' rec {
  ...
  src = fetchFromGitHub {
    owner = "mmsqe";
    repo = pname;
    rev = "23b78f4ab22d69208eda807e2b5d4be2879efdcd";
    hash = "sha256-oBu3Bd0OOclRLbkR34fQmQGGE/pAaNZ9Ip8vuToF9dI=";
  };
  vendorHash = "sha256-+eENe20ToVrCQPEYV9gbbQk67IC2LaqMjiX/murMCAY=";
  proxyVendor = true;
