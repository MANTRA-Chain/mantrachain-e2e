...
buildGo123Module' rec {
  ...
  src = fetchFromGitHub {
    owner = "MANTRA-Chain";
    repo = pname;
    rev = "f301bc2cc5404f0384a19575f2f637034e1d26ed";
    hash = "sha256-B6h9dg2vadzo5juNGQ7tXQX0wQmrcogT5D0ZdquHvlw=";
  };
  vendorHash = "sha256-emBnLPZJdYFJmckXTGd4G7FfYjp8NZsv789epZoid+c=";
  proxyVendor = true;
