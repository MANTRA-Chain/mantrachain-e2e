...
buildGo123Module' rec {
  ...
  src = fetchFromGitHub {
    owner = "mmsqe";
    repo = pname;
    rev = "dd2eb662742f2e88a781cf9c26248bc230ecdce8";
    hash = "sha256-mPmbmUJ3qI0DxbC0EsjUpzglRg+MsBM3ztJjKAzCr8s=";
  };
  vendorHash = "sha256-tFHnmVjboDMaPiI8cMHc0isYeHEp6ny9QY5a2bwBvAI=";
  proxyVendor = true;
