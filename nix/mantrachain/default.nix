...
buildGo123Module' rec {
  ...
  src = fetchFromGitHub {
    owner = "MANTRA-Chain";
    repo = pname;
    rev = "9143dffb27472f3060e0ab419a46241b19ba9545";
    hash = "sha256-lbegy4jlA5TjF54hZDR5Cyc5sY/UaKMVs9bHQnWVZFw=";
  };
  vendorHash = "sha256-1ouTPi9UNSSiGQNcpiyf0c+ihHT70A/aaWinFOEOhmE=";
  proxyVendor = true;
