...
buildGo123Module' rec {
  ...
  src = fetchFromGitHub {
    owner = "MANTRA-Chain";
    repo = pname;
    rev = "556a2557532369b54c059283a23f12646ce5fb1d";
    hash = "sha256-fPkFxhtDzRHTrIekiqlWzmFMf+59URNnWHORaC+7K3g=";
  };
  vendorHash = "sha256-pdVnj5VW+hDcIQ4IkpM58d+yiNhETFDAnhISMONKtvc=";
  proxyVendor = true;
