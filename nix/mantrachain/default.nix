...
buildGo123Module' rec {
  ...
  src = fetchFromGitHub {
    owner = "MANTRA-Chain";
    repo = pname;
    rev = "a7bd374c2f8bdb55e84ff2bb1cfc0102f8d16588";
    hash = "sha256-nDIkfZHLp2NIlK93VXWH9ZNoVOVxhXYlRMEN3bj+tPE=";
  };
  vendorHash = "sha256-tCKwj0baC5Rdsjst17dwP+RrXdctKxwAMKrdzJVOglU=";
  proxyVendor = true;
