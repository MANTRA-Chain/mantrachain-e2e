...
buildGo123Module' rec {
  ...
  src = fetchFromGitHub {
    owner = "MANTRA-Chain";
    repo = pname;
    rev = "310c2727c32ad6ba0f9f9206c5d43949f751cf2d";
    hash = "sha256-u7vl2vxE+O8arcA5VoIcIsu3pte/DNXUfOyzai3yzIM=";
  };
  vendorHash = "sha256-QyhqTHeaZQjtopUjlI7JtFY/N1d3+cuq90jKpu/zG5s=";
  proxyVendor = true;
