...
buildGo123Module' rec {
  ...
  src = fetchFromGitHub {
    owner = "MANTRA-Chain";
    repo = pname;
    rev = "64cccb6cf4bd86bb51f2ad8db4e6d98358b86871";
    hash = "sha256-QUZawLmCrTJnK/kHSs4hT8le4VTZaLLTdh4/kO3Y1D4=";
  };
  vendorHash = "sha256-5+4jm9gh1oZaCDa6py/vvTSC/SWChxF9KJ1W48Y280E=";
  proxyVendor = true;
