...
buildGo123Module' rec {
  ...
  src = fetchFromGitHub {
    owner = "MANTRA-Chain";
    repo = pname;
    rev = "0e0a2273c0b892c1d32bdd1b4730bd8225c4c098";
    hash = "sha256-6DSN0fOrh5Eb26Fn7mJEAfnRiT1lBhhTKfH7meJARdk=";
  };
  vendorHash = "sha256-f9le/RkSoEzf7JWIOghQdvn7F6LYwnX+sNoUP2sjFvg=";
  proxyVendor = true;
