...
buildGoModule' rec {
  ...
  src = fetchFromGitHub {
    owner = "mmsqe";
    repo = "evm";
    rev = "8cb3453bad5920773d1595de8ef9929b4d3f1167";
    hash = "sha256-dNn5AL/OCvV5U7qA2ZZC8wZdp9SYUVHdEEOk2W/coBU=";
  };
  
  vendorHash = "sha256-oMLDLZIaMdtuijcJAuJNw5faDxI/lUi8Ke0y39Pm7l0=";
  proxyVendor = true;
